...
public class SetTileTextures : Editor
{
    ...
    public void LoadListsAndGUIFirst()
    {
        ...
        {
            var b = lowerTileList[a].transform.Find("Editor Sprite");
            if (b != null)
            {
            ...
            var c = lowerTileList[a].transform.Find("Editor Hitbox");
            if (c != null)
            {
        ...
        {
            var b = middleTileList[a].transform.Find("Editor Sprite");
            if (b != null)
            {
                b.gameObject.SetActive(false);
            }
            ...
            var c = middleTileList[a].transform.Find("Editor Hitbox");
            if (c != null)
            {
                c.gameObject.SetActive(false);
        ...
        {
            var b = aboveTileList[a].transform.Find("Editor Sprite");
            if (b != null)
            {
                b.gameObject.SetActive(false);
            }
            ...
            var c = aboveTileList[a].transform.Find("Editor Hitbox");
            if (c != null)
            {
                c.gameObject.SetActive(false);
    ...
    public void DrawCurrentTiles()
    {
        for (int a = 0; a < currentTileList.Length; a++)
        {
            ...
            var b = currentTileList[a].transform.Find("Editor Sprite");
            if (b != null)
            {
